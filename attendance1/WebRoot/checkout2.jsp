<%@ page language="java"
	import="java.util.*,com.gdpi.attendance.form.SubAttendanceComForm,com.gdpi.attendance.dao.TeacherDao; "
	pageEncoding="UTF-8"%>

<%@pagecontentType="application/vnd.ms-word;charset=utf-8"%>
<%	
	response.setHeader("Content-Disposition", "attachment;filename=TimeAttendance.doc");
%>
<html>
	<head>
...
function AllAreaWord() {
		...
		var areaRes = document.getElementById('PrintA'); //指定要输入区域
	...
	<body>
		<table id="PrintA" cellspacing="1" cellpadding="0" width="100%"
			bgcolor="#5e85b1" border="0">
			<tbody>
				<tr>
					<td colspan="7">
						<div align="center">
				...
				<tr>
					<td>
						<table id="attendance" cellspacing="1" cellpadding="0"
							width="100%" border="0">
							<tbody>
								<tr bgcolor="#eef3f9">
									<td>
								...
								<tr bgcolor="ffffff">
									<td>
										<font color="black">【</font><font color="red"><%=subAC.getCheck()%></font><font
											color="black">】</font>
									</td>
									...
									<td>
										请假：<%=subAC.getLeave()%>&nbsp;&nbsp;旷课：<%=subAC.getTruancy()%>&nbsp;&nbsp;迟到：<%=subAC.getLate()%>&nbsp;&nbsp;早退：<%=subAC.getLeaveEarly()%></td>
								</tr>
								<%
