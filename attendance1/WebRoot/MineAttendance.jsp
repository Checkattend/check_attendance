...
<html>
  <head>
  	...
  	<%
  		...
  		studentChecklist = (List<StudentCheckForm>) session.getAttribute("studentChecklist");
  		studentSubjectlist = (List<SubjectForm>) session.getAttribute("studentSubjectlist");
  	%>
  </head>
  
  <body>
  	</table>
    <table cellspacing="0" cellpadding="3" rules="rows" bordercolor="#ADCEEF" border="1" id="AttendanceQuery" width="100%">
    	<tbody>
    		<tr>
    			<td>
    				<table id="sbycategory" cellspacing="1" cellpadding="0" width="100%" border="0">
    					<tbody>
    						<tr><td>查询条件</td></tr>
    						<tr>
    							<td>课程名称:
    								...
    								<input type="submit" name="QueryB" id="QueryB" value="按课程名称查询">
    							</td>
    						</tr>
    					</tbody>
    				</table>
