  					...
  					<table id="backAttendance" cellspacing="1" cellpadding="0" width="100%" border="0">
  						<tbody>
  							...
  							%>
  								...
  								<td>&nbsp;<a  style="text-decoration:none" href="TeacherServlet?method=3&sign=3&SubId=<%=subAC.getId() %>"><img src="lib/ligerUI/skins/icons/ok.gif"></img></a>&nbsp;&nbsp;&nbsp;<img src="lib/ligerUI/skins/icons/back.gif"></img></td>
  								</tr>
  							<%
  									}
  								}
