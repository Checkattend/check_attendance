     ...
     <%@ include file="/pages/commons/header.jsp" %>
        <script type="text/javascript"> 
        	var data = [
            		...
            		{ID:11, TEXT:"个人信息", PID:1, URL:"/TeacherServlet?method=1&sign=1"},
            		{ID:12, TEXT:"查看考勤表", PID:1, URL:"/TeacherServlet?method=2&sign=2"},
            		{ID:13, TEXT:"查看授课班级", PID:1, URL:"/TeacherServlet?method=0&sign=0"},
            		{ID:14, TEXT:"整个学期学生出勤", PID:1, URL:"/TeacherServlet?method=5&sign=5"}
            	];
            $(function ()
            { 
